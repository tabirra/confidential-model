...
#
# Deploys k8s/consumer-pod.yaml (Layer 1+2, Secret/ConfigMap-based key
# delivery) by default. Pass "coco" as the first argument to deploy
# k8s/consumer-pod-coco.yaml instead (Layer 2+3, KBS-attested key delivery):
