...
#
# This only covers the Layer 1+2 manifest (k8s/consumer-pod.yaml); the
# Layer 2+3 attested-release manifest (k8s/consumer-pod-coco.yaml) still
# needs its KBS_RESOURCE_PATH and aa_kbc_params annotation edited by hand.
set -euo pipefail
